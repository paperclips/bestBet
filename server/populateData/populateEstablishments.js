        ...
        data.businesses.forEach(function(item){
          ...
          Establishments.findOrCreate({
            ...
            defaults:{
             ...
             trait1Pos: Math.floor(item.rating*item.review_count),
             trait1Tot: Math.ceil(6*item.review_count),
             trait2Pos: Math.floor(item.rating*item.review_count),
             trait2Tot: Math.ceil(6*item.review_count),
             trait3Pos: Math.floor(item.rating*item.review_count),
             trait3Tot: Math.ceil(6*item.review_count),
             trait4Pos: Math.floor(item.rating*item.review_count),
             trait4Tot: Math.ceil(6*item.review_count),
             trait5Pos: Math.floor(item.rating*item.review_count),
             trait5Tot: Math.ceil(6*item.review_count),
             trait6Pos: Math.floor(item.rating*item.review_count),
             trait6Tot: Math.ceil(6*item.review_count),
             trait7Pos: Math.floor(item.rating*item.review_count),
             trait7Tot: Math.ceil(6*item.review_count),
             trait8Pos: Math.floor(item.rating*item.review_count),
             trait8Tot: Math.ceil(6*item.review_count),
             trait9Pos: Math.floor(item.rating*item.review_count),
             trait9Tot: Math.ceil(6*item.review_count),
            },
            raw:true
          }) 
        })
